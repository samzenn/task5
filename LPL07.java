...
public class LPL07 {
	  public static void main(String[] args) {
		    ...
		    System.out.println("Clubs have lesser than 14 points");
		    table.stream().filter(lplclub -> lplclub.getPoints() <= 14)
		        .forEach(System.out::println);

		    System.out.println();
		    System.out.println("Clubs have Greater than 50 points");
		    table.stream().filter(lplclub -> lplclub.getPoints() >= 50)
		        .forEach(System.out::println);
		  }
}
