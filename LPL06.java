	  ...
	  public static void main(String[] args) {
		    List<lplclub> table = Arrays.asList(
		        ...
		        new lplclub(10, "Royal Challengers", 22, 7, 1, 14, 442, 578, -136, 46, 57, 4, 6,
		            40),
		        new lplclub(11, "Sunrisers Hyderabad", 23, 5, 73, -156, 475, 535, -70, 527, 61,
		                4, 8, 34),
		        new lplclub(12, "London Graters", 22, 0, 0, 22, -223, 1021, -798, 29, 147, 1,
		            0, 1),
		    	new lplclub(13, "Grater Winners", 32, 20, -450, 62, 13, 1060, -718, 49, 74, 8,
		            0, 1));


		    System.out.println("Several clubs have 14 points");
		    table.stream().filter(lplclub -> lplclub.getPoints() == 14)
		        .forEach(System.out::println);

		    System.out.println();
		    System.out.println("Filter by Club name - Colombo Kings");
		    table.stream().filter(lplclub -> lplclub.getClub() == "Colombo Kings")
		        .forEach(System.out::println);
		    System.out.println();
		    System.out.println("Filter by Club name - Grater Winners");
		    table.stream().filter(lplclub -> lplclub.getClub() == "Grater Winners")
		        .forEach(System.out::println);
